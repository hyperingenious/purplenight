  ...
  const features = [
    {
      ...
      img: '/herosection-images/sharingIm.svg',
      description:
    ...
    },
    {
      ...
      img: '/herosection-images/aiImg.svg',
      description:
    ...
    },
    {
      ...
      img: '/herosection-images/selectImg.svg',
      description:
    ...
    },
    {
      ...
      img: '/herosection-images/postImg.svg',
      description:
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-8">
        {features.map((feature, idx) => (
          <div key={idx} className="p-4 bg-white rounded-lg shadow-md">
            <img src={feature.img} alt={feature.title} className="h-32 mx-auto" />
